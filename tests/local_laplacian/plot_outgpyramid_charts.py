...
algorithms = ['local_laplacian']
hostnames = ['i38']
image_sizes = ['4K', '10K']
schedules = ['serial', 'serial_vec', 'parallel_with_vec']
stages = [
  'outGPyramid[0]', 'outGPyramid[1]', 'outGPyramid[2]', 'outGPyramid[3]', 'outGPyramid[4]', 'out'
]

colors = [
  '#44ff00ff', '#88ff00ff', '#00ff00ff', '#00bb00ff', '#008800ff', '#004400ff', '#000000ff'
]
...
for i in range(0, counter, scheds):
  ...
  fig.savefig("pdf/{}_time_per_schedule_{}_outGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  if img_size == '4K':
    plt.yticks([0, 4, 8, 12, 16], ["0M", "4M", "8M", "12M", "16M"])
    plt.ylim(top=16)

  else:
    plt.yticks([0, 20, 40, 60, 80], ["0M", "20M", "40M", "60M", "80M"])
    plt.ylim(top=80)

  plt.legend(ncol=2, prop={'size': 10})
  plt.tight_layout()

  fig.savefig("pdf/{}_cache_miss_per_schedule_{}_outGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_flop_per_schedule_{}_outGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_data_volume_per_schedule_{}_outGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
