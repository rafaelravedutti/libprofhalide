...
stages = [
  'gPyramid[1]', 'gPyramid[2]', 'gPyramid[3]', 'gPyramid[4]', 'gPyramid[5]', 'gPyramid[6]', 'gPyramid[7]'
]

colors = [
  '#0044ffff', '#0088ffff', '#ff00ffff', '#0000bbff', '#000088ff', '#000044ff', '#000000ff'
]
...
for i in range(0, counter, scheds):
  ...
  fig.savefig("pdf/{}_time_per_schedule_{}_gPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_cache_miss_per_schedule_{}_gPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_flop_per_schedule_{}_gPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_data_volume_per_schedule_{}_gPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
