...
stages = [
  'inGPyramid[1]', 'inGPyramid[2]', 'inGPyramid[3]', 'inGPyramid[4]', 'inGPyramid[5]', 'inGPyramid[6]', 'inGPyramid[7]'
]

colors = [
  '#ff4400ff', '#ff8800ff', '#ff0000ff', '#bb0000ff', '#880000ff', '#440000ff', '#000000ff'
]
...
for i in range(0, counter, scheds):
  ...
  fig.savefig("pdf/{}_time_per_schedule_{}_inGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_cache_miss_per_schedule_{}_inGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_flop_per_schedule_{}_inGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
  ...
  fig.savefig("pdf/{}_data_volume_per_schedule_{}_inGPyramid.pdf".format(algorithms[0], img_size), bbox_inches = 'tight', pad_inches = 0)
