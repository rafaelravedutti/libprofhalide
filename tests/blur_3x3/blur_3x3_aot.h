#ifndef HALIDE__blur_3x3_aot_h
#define HALIDE__blur_3x3_aot_h
#include <stdint.h>
...
int blur_y(struct halide_buffer_t *_b0_buffer, struct halide_buffer_t *_blur_y_buffer) HALIDE_FUNCTION_ATTRS;
int blur_y_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *blur_y_metadata() HALIDE_FUNCTION_ATTRS;
