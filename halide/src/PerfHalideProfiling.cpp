...
class InjectPerfHalideProfiling : public IRMutator2 {
public:
    ...
    InjectPerfHalideProfiling(const string &pipeline_name) : pipeline_name(pipeline_name) {
        indices["overhead"] = 0;
        stack.push_back(0);
    }
...
private:
    ...
    */
    ...
    Stmt visit(const ProducerConsumer *op) override {
        ...
        Expr set_task = Call::make(Int(32), "perf_halide_set_current_func",
...
Stmt inject_perf_halide_profiling(Stmt s, string pipeline_name) {
    InjectPerfHalideProfiling profiling(pipeline_name);
    ...
    Expr start_profiler = Call::make(Int(32), "perf_halide_pipeline_start",
    ...
    */
    ...
    Expr stop_profiler = Call::make(Int(32), Call::register_destructor,
                                    {Expr("perf_halide_pipeline_end"), get_state}, Call::Intrinsic);
